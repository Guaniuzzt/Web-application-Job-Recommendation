...
public class MonkeyLearnClient {
	private static final String API_KEY = "11a40ec6e50e645f28886491400124b9f1418e67";// make sure change it to your api key.
	/*
	 * public static void main(String[] args) {
	 * 
	 * String[] textList = {
	 * "Elon Musk has shared a photo of the spacesuit designed by SpaceX. This is the second image shared of the new design and the first to feature the spacesuit’s full-body look."
	 * }; List<List<String>> words = extractKeywords(textList); for (List<String> ws
	 * : words) { for (String w : ws) { System.out.println(w); }
	 * System.out.println(); } }
	 */
